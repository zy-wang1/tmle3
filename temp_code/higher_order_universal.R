...
saveRDS(report_list, "./temp_output/higher_order_universal_ZW-20201223.rds")
...
plot1
ggsave("./temp_output/bias_higher_order_universal.jpg", plot1, width = 8, height = 8, units = "in", dpi = 300)
...
plot1 <- ggplot(data=test_data_long,
  ...
  scale_x_discrete(name ="Bias Mass",
                   breaks = plot_df$Bias.Mass)
plot1
ggsave("./temp_output/ratio_higher_order_universal.jpg", plot1, width = 12, height = 8, units = "in", dpi = 300)
...
plot1 <- ggplot(data=test_data_long,
  ...
  scale_x_discrete(name ="Bias Mass",
                   breaks = plot_df$Bias.Mass)
plot1
ggsave("./temp_output/mse_higher_order_universal.jpg", plot1, width = 8, height = 8, units = "in", dpi = 300)

...
###
# one-step, maxit=1000, de=0.001
###
updater <- tmle3_Update_middle$new(maxit = 250, convergence_type = "scaled_var",
                                   fluctuation_type = "standard", submodel_type = "onestep", d_epsilon = 0.001, if_direction = T,
                                   cvtmle = F)
targeted_likelihood <- Targeted_Likelihood$new(initial_likelihood, updater)
tmle_params <- middle_spec$make_params(tmle_task, targeted_likelihood)
updater$tmle_params <- tmle_params
...
###
# one-step, maxit=1000, de=0.001, cvtmle
###
updater <- tmle3_Update_middle$new(maxit = 250, convergence_type = "scaled_var",
                                   fluctuation_type = "standard", submodel_type = "onestep", d_epsilon = 0.001, if_direction = T,
                                   cvtmle = T)
...
###
# projection one-step, maxit=1000, de=0.001
###
